...
import logoSponsor1 from "../../assets/images/airtel.png";
import logoSponsor2 from "../../assets/images/airtel.png";
import logoLinkFooter from "../../assets/images/airtel.png";
            ...
            <div className="footer-container-2">
              <div className="copyright">
                <p className="copyright-text">
                  {" "}
                  Copyright &copy; 2023 DINITECH.réaliser par Tolotra & Finoana
                </p>
              </div>
